...
export default function ServiceDetail() {
  ...
  const breadcrumbItems = [
    ...
    {
      label: isMedical
        ? t('medicalInsurance', 'breadcrumbMedical')
        : t('financialInsurance', 'breadcrumbFinancial'),
      href: isMedical ? '/services/medical-insurance' : '/services/financial-insurance',
    },
  ...
  return (
    <>
      <Helmet>
        <title>{td(isMedical ? 'medicalCenters' : 'banks', entity.name, 'name')} - Mustakleen</title>
      </Helmet>
      ...
      <section className="py-16 bg-cream">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <Link
              to={isMedical ? '/services/medical-insurance' : '/services/financial-insurance'}
              className="inline-flex items-center gap-2 text-gold font-bold mb-8 hover:underline"
            >
              <ArrowLeft size={18} />
              {t(isMedical ? 'medicalInsurance' : 'financialInsurance', isMedical ? 'breadcrumbMedical' : 'breadcrumbFinancial')}
            </Link>
