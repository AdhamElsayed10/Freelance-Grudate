            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
                ...
                <p className="text-2xl font-bold text-blue-800">
                  {revenueUsers.filter(u => u.plan === 'premium').length} <span className="text-sm font-normal text-blue-600">× 99</span>
                </p>
              </div>
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-200">
                <p className="text-purple-700 text-xs font-semibold mb-1">{t('adminDashboard', 'revenueModalElite')}</p>
                <p className="text-2xl font-bold text-purple-800">
                  {revenueUsers.filter(u => u.plan === 'elite').length} <span className="text-sm font-normal text-purple-600">× 199</span>
                </p>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                <p className="text-gray-600 text-xs font-semibold mb-1">{t('adminDashboard', 'revenueModalFree')}</p>
                <p className="text-2xl font-bold text-gray-700">{revenueUsers.filter(u => u.plan === 'free').length}</p>
              </div>
            </div>
